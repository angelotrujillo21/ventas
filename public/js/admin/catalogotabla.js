...
function fncPopulate(jsnData, fncCallback) {
    $.ajax({
        type: 'post',
        url: web_root + 'catalogoTabla/populate',
        data: jsnData,
        dataType: 'json',
        beforeSend: function() {
            fncMostrarLoader();
...
function fncGrabarTabla(jsnData, fncCallback) {
    $.ajax({
        type: 'post',
        dataType: 'json',
        url: web_root + 'catalogoTabla/fncGrabaCatalogo',
        data: jsnData,
        beforeSend: function() {
            fncMostrarLoader();
        },
...
function fncGrabaCatalogoItem(jsnData, fncCallback) {
    $.ajax({
        type: 'post',
        dataType: 'json',
        url: web_root + 'catalogoTabla/fncGrabaCatalogoItem',
        data: jsnData,
        beforeSend: function() {
            fncMostrarLoader();
        },
...
function fncBuscarRegistro(jsnData, fncCallback) {
    $.ajax({
        type: 'post',
        dataType: 'json',
        url: web_root +  'catalogoTabla/fncMostrarRegistro',
        data: jsnData ,
        beforeSend: function () {
            fncMostrarLoader();
        },
...
function fncListadoItemsPadre(jsnData, fncCallback){
    $.ajax({
            type: 'post',
            url:  web_root+'catalogoTabla/fncListadoItemsPadre',
            data: jsnData,
            dataType: 'json',
            beforeSend: function () {
                fncMostrarLoader();
...
function fncEjecutarCambiarEstado ( jsnData, fncCallback ) {
    ...
    $.ajax({
        type: 'post',
        url: web_root + 'catalogoTabla/fncCambiarEstado',
        data: jsnData,
        dataType: 'json',
        beforeSend: function () {
            fncMostrarLoader();
...
function fncEjecutarEliminarRegistro ( jsnData , fncCallback ) {
    ...
    $.ajax({
        type: 'post',
        url: web_root + 'catalogoTabla/fncEliminarRegistro',
        data: jsnData,
        dataType: 'json',
        beforeSend: function () {
            fncMostrarLoader();
