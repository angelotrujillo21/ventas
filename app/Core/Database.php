        ...
        if (count($array) > 0 && is_array($array)) {
            ...
            foreach ($array as $sKey => $sValue) {
                ...
                if (is_null($sValue)) {
                    ...
                    if ($sValue == 'CURDATE()' || substr($sValue, 0, 11) == 'STR_TO_DATE') {
                        $sString =  $sValue;
                    } elseif ($sValue == 'NOW()') {
                        $sString = $this->quote(date("Y-m-d H:i:s"));
                    } else {
                        $sString = $this->quote($sValue);
                    }
                }
            ...
            foreach ($array as $sKey => $sValue) {
                ...
                if (!is_null($sValue)) {
                    if ($sValue == 'CURDATE()' || substr($sValue, 0, 11) == 'STR_TO_DATE') {
                        ...
                        $sString = " $sKey = '" . date("Y-m-d H:i:s") . "'";
                    } else {
                        $sString = " $sKey = {$this->quote($sValue)} ";
                    }
                }
