...
class ApisController extends Controller
{
    ...
    public function getApiDev($type, $numero)
    {
      ...
      //  $ch    = curl_init("http://localhost/ventas/api/" . $type . "/" . $numero); // Initialise cURL
            ...
            if ($busqueda->success === true) {
                ...
                if ($busqueda->success === true) {
                    $response = [
                        ...
                        "razonSocial" => $busqueda->data->nombre_o_razon_social,
                        "direccion"   => property_exists( $busqueda->data , "direccion_completa") ? $busqueda->data->direccion_completa : ""
                    ];
                    $this->json(array("success" => $response));
                } else {
