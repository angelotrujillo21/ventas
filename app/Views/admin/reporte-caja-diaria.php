                                                ...
                                                <table data-toggle="table" id="table" data-toggle="table" data-search="true" data-query-params="queryParams" toolbarAlign="left" data-show-refresh="false" data-pagination="true" data-toolbar="#toolbar" data-buttons-align="left" data-show-columns="true" data-pagination-h-align="left" data-pagination-detail-h-align="right" data-classes="table table-hover table-condensed" data-striped="true" data-buttons-class="gradient-primary-table" data-card-view="false" data-page-size="14" data-sort-name="" data-sort-order="asc">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th data-field="nSaldoAnterior" data-sortable="true">Saldo anterior</th>
                                                            ...
                                                            <th data-field="nTotalOC" data-sortable="true">Gastos/Compras</th>
...
<script>
    $(function() {
        ...
        $("#formFilter").find("form").on('submit', function(event) {
            ...
            if(!nIdCaja || nIdCaja == '0'){
                toastr.error('Error.Debe de seleccionar una caja. Por favor verificar.');
                return;
            }
            ...
            var jsnData = {
             ...
             fncPopulateReporteCajaIndividual(jsnData, function(aryData) {
                bFilterTable  = true;
    ...
    window.fncClearFilterM = () => {
        ...
        $("#nIdCaja").val(null).trigger("change");
  
    }

    // Llamadas al servidor
    function fncPopulateReporteCajaIndividual(jsnData, fncCallback) {
        $.ajax({
            type: 'post',
            dataType: 'json',
            url: web_root + 'cajas/fncPopulateReporteCajaIndividual',
            data: jsnData,
            beforeSend: function() {
                fncMostrarLoader();
            },
