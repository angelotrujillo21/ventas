            ...
            <div id="fondo-login" class="content-wrapper d-flex align-items-center auth fondo-login">
                <div class="row flex-grow">
                    <div class="col-lg-4 mx-auto">
                        ...
                        <div class="auth-form-light text-center p-5" style="border-radius: 25px">
                            <div class="brand-logo">
                                <img id="logo" class="img img-fluid img-login" src="<?= src('app/app-logo.svg') ?>">
                            </div>
                            <h4 style="color:#004481;  font-weight: bold">¡Hola! Empecemos</h4>
                            <h6 style="color:#004481">Inicia sesión para continuar.</h6>
    ...
    $(document).ready(function() {
        ...
        $("#nIdEmpresa").on("change", function() {
            ...
            if ( $(this).val() == null || $(this).val() == '') {
                $("#logo").attr("src", src('app/app-logo.png'));
                $("#fondo-login").attr("style", `background-image: linear-gradient( to right, rgba(147, 231, 212, 0.52),rgba(0, 123, 255, 0.73)),url("${src('app/login-fondo.jpg' )}") !important;`);
                return false;
            }
