                        ...
                        <div class="row">
                           ...
                           <div class="col-12 col-md-12">
                               <div class="form-group">
                                   <label for="aryIdCajas" class="col-form-label">Cajas</label>
                                   <select class="form-control" name="aryIdCajas" id="aryIdCajas" multiple>
...
<script>
    $(function() {
        ...
        $("#formFilter").find("form").on('submit', function(event) {
            ...
            if(!aryIdCajas || aryIdCajas.length == 0){
