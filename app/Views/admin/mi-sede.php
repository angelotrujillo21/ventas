                                            ...
                                            <div class="col-12">
                                                <form data-nidregistro="<?=$user['nIdSede']?>" data-nidempresa="<?=$user['nIdEmpresa']?>"  id="formCESede">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12 col-md-6">
                                                            <div class="form-group">
                                                                <label for="nEnvioAutomaticoSUNAT" class="col-form-label">Envío automático SUNAT</label>
                                                                <select class="form-control" name="nEnvioAutomaticoSUNAT" id="nEnvioAutomaticoSUNAT">
...
<script>
    $(function() {
        ...
        $("#formCESede").on('submit', function(event) {
            ...
            var nEnvioAutomaticoSUNAT = $("#nEnvioAutomaticoSUNAT").val();
            ...
            formData.append('nEnvioAutomaticoSUNAT', nEnvioAutomaticoSUNAT);
    ...
    function fncMostrarSede(nIdRegistro) {
        ...
        fncBuscarRegistroSede(jsnData, function(aryResponse) {
            ...
            if (aryResponse.success) {
                ...
                $("#nEnvioAutomaticoSUNAT").val(aryData.nEnvioAutomaticoSUNAT);
