                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 mb-4">
                                <div class="card card-small">
                                    <div class="card-body pt-1 pb-5">
                                        ...
                                        <div class="row my-2">
                                            <div class="col-12">
                                                <table data-toggle="table" id="table" data-url="<?= route('ordenCompra/fncPopulate?nTipo='.$nTipoGasto) ?>" data-toggle="table" data-search="true" data-query-params="queryParams" toolbarAlign="left" data-show-refresh="true" data-pagination="true" data-toolbar="#toolbar" data-buttons-align="left" data-show-columns="true" data-pagination-h-align="left" data-pagination-detail-h-align="right" data-classes="table table-hover table-condensed" data-striped="true" data-buttons-class="gradient-primary-table" data-card-view="false" data-page-size="14" data-sort-name="" data-show-footer="true"  data-sort-order="asc">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th data-visible="false" data-field="sProcesado" data-sortable="true">Procesado</th>
                                                            <th data-field="sEjecutado" data-sortable="true">Ejecutado</th>
                                                ...
                                                <!-- <div class="offset-0 col-12 col-md-6 offset-md-6 my-2">
                                                  <table class="table table-bordered">

                                                    <tr>
                                                        <td id="sTituloGastos" class="text-center bg-header-table font-weight-bold" colspan="2"></td>
                                                    </tr>
                            ...
                            <div class="row  ">
                                ...
                                <div class="col-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="nIdCaja" id="nIdCaja" class="form-control">
                                ...
                                <div class="col-12 col-md-4 mb-2">
                                    <div class="form-group">
                                        ...
                                        <select name="nProcesadoOC" id="nEstadoOC" class="form-control">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row border-alll-light">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <label for="nIdOrdenCompraFilter" class="col-form-label">Cod.Gasto:</label>
...
<script>
    ...
    $(function() {
        ...
        $("#btnCrearOC").on('click', function() {
            ...
            $("#nIdProducto,#nIdUnidadMedida").val("").trigger("change");
            $("#formOC").find(".modal-title").html('Nueva Gasto');
        ...
        $("#btnGuardarOC").on("click", function() {
            ...
            if (aryDetalle.length == 0) {
                ...
                toastr.error('Error. Debe de seleccionar una caja. Por favor verifique.');
                return false;
            } 
    ...
    function fncMostrarOC(nIdRegistro,sAccion) {
        ...
        fncBuscarRegistro(jsnData, function(aryResponse){
                ...
                if (aryResponse.success) {
                    ...
                    $("#nIdProveedorCab").val(aryData.nIdProveedor);
                    ...
                    if (sAccion == 'editar') {
                        $("#formOC").find(".modal-title").html("Editar Gasto");
                        fncControles(false);
                    } else {
                        $("#formOC").find(".modal-title").html("Ver Gasto");
                        fncControles(true);
                    }
    ...
    window.fncTotales = function(nIdProducto = null, sTable, event = null) {
        ...
        if ($(sTable).find("tbody").find("tr").length > 0) {
            ...
            $(sTable).find("tbody").find("tr").each(function() {
                ...
                $(this).find("td").eq(8).find("div").html(fncNf(nTotalItem));
