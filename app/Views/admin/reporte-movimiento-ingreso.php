                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 mb-4">
                                <div class="card card-small">
                                    <div class="card-body pt-1 pb-5">
                                        ...
                                        <div class="row my-2">
                                            <div class="col-12">
                                                <table data-toggle="table" id="table" data-toggle="table" data-search="true"  data-export-footer="true" data-show-footer="true" data-query-params="queryParams" toolbarAlign="left" data-show-refresh="true" data-pagination="true" data-toolbar="#toolbar" data-buttons-align="left" data-show-columns="true" data-pagination-h-align="left" data-pagination-detail-h-align="right" data-classes="table table-hover table-condensed" data-striped="true" data-buttons-class="gradient-primary-table" data-card-view="false" data-page-size="14" data-sort-name="" data-sort-order="asc">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th data-field="sUbicacionAlmacen"  data-footer-formatter="fncLabelFooter"  data-sortable="true">Ubicacion </th>
...
<script>
    $(function() {
        ...
        $("#formFilter").find("form").on('submit', function(event) {
            ...
            fncPopulateReporteEntrada(jsnData, function(aryData) {
                bFilterTable  = true;
    ...
    function fncPopulateReporteEntrada(jsnData, fncCallback) {
        $.ajax({
            type: 'post',
            dataType: 'json',
            url: web_root + 'movimientos/fncPopulateReporteEntrada',
            data: jsnData,
            beforeSend: function() {
                fncMostrarLoader();
            },
