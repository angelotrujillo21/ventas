...
<body data-nadmin="<?= $nAdmin ?>" data-nidcajaempleadoventa="<?= $nIdCajaEmpleadoVenta ?>" data-nidestadopagopagado="<?= $nIdEstadoPagoPagado ?>" data-ntipomoneda="<?= $arySede["nTipoMoneda"] ?>" data-ntipocomprofactura="<?= $nTipoComproFactura ?>" data-ntipocomproboleta="<?= $nTipoComproBoleta ?>" data-ntipocomproordencompra="<?= $nTipoComproOrdenCompra ?>" data-ntipodocdni="<?= $nTipoDocDNI ?>" data-ntipodocruc="<?= $nTipoDocRUC ?>" data-nidmetodoenviort="<?= $nIdMetodoEnvioRT ?>" data-nestadoenvioentregado="<?= $nEstadoEnvioEntregado ?>">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 mb-4">
                                <div class="card card-small">
                                    <div class="card-body pt-1 pb-5">
                                        ...
                                        <div class="row my-2">
                                            <div class="col-12">
                                                <div class="d-flex align-items-center p-2">
                                                    ...
                                                    <div class="ml-auto">
                                                        <button id="btnCrearPedido" class="btn btn-gradient-primary btn-rounded btn-icon">
                                        ...
                                        <div class="row my-2">
                                            <div class="col-12">
                                                <table data-toggle="table" id="table" data-url="<?= route('pedidos/fncPopulate') ?>" data-export-footer="true" data-show-footer="true" data-toggle="table" data-search="true" data-query-params="queryParams" toolbarAlign="left" data-show-refresh="true" data-pagination="true" data-toolbar="#toolbar" data-buttons-align="left" data-show-columns="true" data-pagination-h-align="left" data-pagination-detail-h-align="right" data-classes="table table-hover table-condensed" data-striped="true" data-buttons-class="gradient-primary-table" data-card-view="false" data-page-size="14" data-sort-name="" data-sort-order="asc">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th data-field="nTotalBrutoDetalle" data-sortable="true">Total Bruto Detalle</th>
                                                            ...
                                                            <th data-field="nTotal" data-footer-formatter="fncTotalFooter" data-sortable="true">Total a Pagar</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                    </tbody>
    ...
    <div class="modal fade modal-full-screen" id="formPedido" tabindex="-1" role="dialog" aria-labelledby="formPedidoLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">

                <div class="modal-header">
                    <h5 class="modal-title" id="formPedidoLabel">Nuevo venta</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4 border-right-add-prod">
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col-12 Contentcotizacion">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-grow-1 bd-highlight">
                                ...
                                <div class="col-12 my-2 Contentcotizacion">
    ...
    <div class="modal fade" id="formReporte" tabindex="-1" role="dialog" aria-labelledby="formReporteLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="formPedidoLabel">Vista Previa reporte</h5>
                    <button type="button" class="btn btn-close btn-gradient-primary btn-rounded p-0" data-dismiss="modal" aria-label="Close">
                        <i class="fas fa-times"></i>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div id="content-table-report" class="col-12 col-md-12">
                ...
                <form>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-12">
                                <div class="form-group">
                                    <label for="aryIdClientes" class="col-form-label">Clientes</label>
                                    <select class="form-control" name="aryIdClientes" id="aryIdClientes" multiple>
                                    ...
                                    <select class="form-control" name="aryProductos" id="aryProductos" multiple>
                                        <?php if (fncValidateArray($aryProductos)) : ?>
                                            <?php foreach ($aryProductos as $aryLoop) : ?>
                                                <option value="<?= $aryLoop["nIdProducto"] ?>"><?= (strlen($aryLoop["sCodigoInterno"]) ?  $aryLoop["sCodigoInterno"] . " - " : "") . strup($aryLoop["sDescripcion"]) . " " . $aryLoop["sUnidadMedidaCorto"] ?></option>
                                            <?php endforeach ?>
                                        <?php endif ?>
                                    </select>
                                </div>
...
<script>
    ...
    $(function() {
        ...
        $("#nIdProducto,#nIdCliente").val(0).trigger("change");
        ...
        $("#btnCrearPedido").on('click', function() {
            ...
            $("#nIdMetodoEnvio").val($("body").data("nidmetodoenviort"));
            $("#nEstadoEnvio").val($("body").data("nestadoenvioentregado"));
            $("#formPedido").find(".modal-title").html('Nueva Venta');
            $("#formPedido").data("nIdRegistro", 0);

            // Obtener las cajas disponibles de hoy
            var jsnData = {
                dFechaHoraApertura: moment().format("DD/MM/YYYY"),
                nEstado: 1
            };
            fncDrawCajas("#nIdCaja", jsnData, $("body").data("nidcajaempleadoventa"));

            if ($("body").data("nidcajaempleadoventa") == 0) {
        ...
        $("#btnGuardarPedido").on("click", function() {
            ...
            var nIdRegistro = $("#formPedido").data("nIdRegistro");
            ...
            var jsnData = {
                ...
                nIdCaja: typeof nIdCaja == 'undefined' || nIdCaja == 0 || nIdCaja == '' ? null : nIdCaja,
                ...
                nIdPedidoCD: nIdPedidoCD == 0 ? null : nIdPedidoCD,
                nIdCotizacion: nIdCotizacion == 0 ? null : nIdCotizacion
            };
                ...
                if (aryResponse.success) {
                    ...
                    setTimeout(() => {
                        ...
                        aryResponse.aryDetalle.forEach(element => {
                            ...
                            // Valida si el JSON tiene daata este json es un array con el nombre del extra y los valores de este ..
                            var sExtra = "";
    ...
    window.fncEliminarPedido = function(nIdRegistro) {
    ...
    window.fncMostrarPedido = function(nIdRegistro, sAccion) {

        fncCleanVenta();
        fncOcultarAside();
        $("#formPedido").data("nIdRegistro", nIdRegistro);
        $(".cartaPD").hide();
        $(".Contentcotizacion").hide();

        var jsnData = {
            nIdRegistro: nIdRegistro
        };

        fncBuscarPedido(jsnData, function(aryResponse) {

            if (aryResponse.success) {

                var aryPedido = aryResponse.aryPedido;
                var aryPedidoDetalle = aryResponse.aryPedidoDetalle;


                // Obtener las cajas disponibles de segun el dia que se creo y no se puede editar
                var jsnData = {
                    dFechaHoraApertura: aryPedido.dFechaRegistro
                };

                if (aryPedido.nIdCaja > 0) {
                    fncDrawCajas("#nIdCaja", jsnData, aryPedido.nIdCaja);
                    $("#nIdCaja").prop("disabled", true);
                }


                $("#formPedido").data("nDespachado", aryPedido.nDespachado);

                fncDrawCliente("#nIdCliente", aryPedido.nIdCliente);

                $("#nIdMetodoPago").val(aryPedido.nIdMetodoPago);
                $("#nEstadoPago").val(aryPedido.nEstadoPago);
                $("#nIdMetodoEnvio").val(aryPedido.nIdMetodoEnvio);
                $("#nEstadoEnvio").val(aryPedido.nEstadoEnvio);
                $("#nEfectivo").val(aryPedido.nEfectivo);
                $("#nVuelto").val(aryPedido.nVuelto);
                $("#dFechaCreacion").val(aryPedido.dFechaCreacion);
                $("#sDescripcionPedido").val(aryPedido.sDescripcion);
                $("#nCondicionPago").val(aryPedido.nCondicionPago);

                // Descuentos 
                $("#nDsct").val(aryPedido.nDescuento);
                $("#nCanjePuntos").val(aryPedido.nPuntosCanje);
                $("#nCanjePuntos").data("nPuntosDsct", aryPedido.nPuntosCanje);
                $("#nCanjePuntos").data("nMontoDsct", aryPedido.nDescuentoCanje);

                $("#nIdResponsableDelivery").val(aryPedido.nIdResponsableDelivery);

                var jsnData = {
                    nIdMetodoPago: aryPedido.nIdMetodoPago
                };
                fncDrarwCC("#nIdCuentaCorriente", jsnData, aryPedido.nIdCuentaCorriente);

                if (aryPedidoDetalle.length > 0) {

                    aryPedidoDetalle.forEach((aryItem, nIndex) => {

                        var jsnRow = {
                            //nIdDetallePedido : aryItem.nIdDetallePedido,
                ...
                $("#formPedido").find(".modal-title").html((sAccion == 'editar' ? 'Editar' : 'Ver') + ' Venta');
                $("#formPedido").modal("show");
            } else {
                toastr.error(aryData.error);
            }
    ...
    window.fncGenerarDocPedido = function(nIdPedido, sPedidoFormat, nTipoDocumento, sNumeroDocumento, sNombreCliente) {

        fncRemoveDisabled($("#formFacturacion").find("form"));
        $("#formFacturacion").data("nIdRegistro", 0);
        $("#formFacturacion").find(".modal-title").html("Generar Comprobante");
        $("#nIdPedidoF").data("nIdPedido", nIdPedido);
        $("#nIdPedidoF").val(sPedidoFormat);

        // $("#nIdPedidoF").data("sNombreoRazonCliente",sNombreCliente);
        // $("#nIdPedidoF").data("nTipoDocCliente",nTipoDocumento);
        // $("#nIdPedidoF").data("sNumeroDocCliente",sNumeroDocumento);

        $("#dFechaEmisionF").val(moment().format('DD/MM/YYYY'));
        $("#nTipoDocumentoF").val(nTipoDocumento);
        $("#sNombreoRazonSocialF").val(sNombreCliente);
        $("#sNumeroDocumentoF").val(sNumeroDocumento);
    ...
    window.fncControles = (bFlag) => {
        // bloquear
        if (bFlag) {
            $("#nIdCliente").attr("disabled", "disabled");
            $("#nIdMetodoPago,#nEstadoPago,#nIdMetodoEnvio,#nEstadoEnvio").attr("disabled", "disabled");
            $("#dFechaCreacion").attr("disabled", "disabled");
            $("#sDescripcionPedido").attr("disabled", "disabled");

            $("#nDsct").attr("disabled", "disabled");
            $("#nCanjePuntos").attr("disabled", "disabled");

            $("#nIdResponsableDelivery").attr("disabled", "disabled");
            $("#nIdCuentaCorriente").attr("disabled", "disabled");
            $("#nCondicionPago").attr("disabled", "disabled");


            $("#btnBuscarPuntos,#btnClearPuntos").hide();
            $("#btnCrearCliente").hide();
            $("#form-add-producto").hide();
            $("#content-vuelto").hide();
            $("#formPedido").find(".modal-footer").hide();
        } else {
            $("#nIdCliente").removeAttr("disabled");
            $("#nIdMetodoPago,#nEstadoPago,#nIdMetodoEnvio,#nEstadoEnvio").removeAttr("disabled");
            $("#dFechaCreacion").removeAttr("disabled");
            $("#sDescripcionPedido").removeAttr("disabled");
            $("#nDsct").removeAttr("disabled");
            $("#nCanjePuntos").removeAttr("disabled");
            $("#btnBuscarPuntos,#btnClearPuntos").show();

            $("#nIdResponsableDelivery").removeAttr("disabled");
            $("#nIdCuentaCorriente").removeAttr("disabled");
            $("#nCondicionPago").removeAttr("disabled");

            $("#btnCrearCliente").show();
            $("#form-add-producto").show();
            $("#content-vuelto").show();
            $("#formPedido").find(".modal-footer").show();
        }
    }
    ...
    function fncEjecutarEliminarRegistro(formData, fncCallback) {
        $.ajax({
            type: 'post',
            dataType: 'json',
            url: web_root + 'pedidos/fncEliminarPedido',
            data: formData,
            beforeSend: function() {
                fncMostrarLoader();
            },
    ...
    function fncBuscarPedido(formData, fncCallback) {
        $.ajax({
            type: 'post',
            dataType: 'json',
            url: web_root + 'pedidos/fncMostrarPedido',
            data: formData,
            beforeSend: function() {
                fncMostrarLoader();
            },
    ...
    function fncObtenerCajasDisponibles(formData, fncCallback) {
        $.ajax({
            type: 'post',
            dataType: 'json',
...
<script>
    $(function() {
        ...
        $("#aryIdPedido,#aryProductos,#aryMetodoPago,#aryEstadoPago,#aryMetodoEnvio,#aryEstadoEnvio,#aryIdClientes").select2({
            placeholder: "TODOS"
        });
        ...
        $("#formFilter").find("form").on('submit', function(event) {
            ...
            var aryIdClientes = $("#aryIdClientes :selected").map(function(nIndex, item) {
                return $(item).val();
            }).get();
    ...
    window.fncClearFilterM = () => {
        ...
        $("#aryIdPedido,#aryProductos,#aryMetodoPago,#aryEstadoPago,#aryMetodoEnvio,#aryEstadoEnvio,#aryIdClientes").val([]).trigger("change");
        $("#nFacturado").val("");
...
<script>
    $(function() {
        ...
        $("#nTipoComprobanteF").change(function() {
            ...
            //     if( $("#nTipoDocumentoF").val() == $("#nIdPedidoF").data("nTipoDocCliente") ){
            //         $("#sNumeroDocumentoF").val($("#nIdPedidoF").data("sNumeroDocCliente"));
            //         $("#sNombreoRazonSocialF").val($("#nIdPedidoF").data("sNombreoRazonCliente"));
            //     } else {
            //         $("#sNumeroDocumentoF").val("");
            //         $("#sNombreoRazonSocialF").val("");
            //     }
    ...
    window.fncMostrarDocPedido = function(nIdRegistro, sPedidoFormat, sOpcion) {
        ...
        fncBuscarFactura(jsnData, function(aryResponse) {
            ...
            if (aryResponse.success) {
                ...
                if (sOpcion == 'editar') {
                    fncEditForm("#formFacturacion", "Editar Comprobante");
                } else {
                    fncViewForm("#formFacturacion", "Ver Comprobante");
                }
    ...
    function fncBuscarFactura(formData, fncCallback) {
        $.ajax({
            type: 'post',
            dataType: 'json',
